...
public class UndirectedGraph{
    ...
    /**
     * Adds edge to the graph given 2 vertices and a cost 
     * It will add vertices to the graph if they weren't already in there
     * @param N1 First Vertex to be added
     * @param N2 Second Vertex to be added
    ...
    /**
     * This method removes an Edge from each of its connections
     * Beware it doesn't check connectivity or create a new edge
    ...
    /**
     * Removes a vertex from the graph this included removing all its edge connection
     * and removing all of these edges from its neighbors
