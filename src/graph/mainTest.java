...
import mixedIntegerProgramming.FlowILP;
...
//            System.exit(1);
    ...
    /**
     * Reads all files from a given directory. The directory is allowed to be
     * both a folder or a file.
     *
     * @param directory The directory for which file(s) have to be read.
